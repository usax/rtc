...
<f:view>
	<h:form>
		...
		<h:commandLink actionListener="#{temperatureConvertor.openPopupClicked}" value="open popup" />
	...
	<h:outputLabel value="#{temperatureConvertor.keys}"></h:outputLabel>
	
	<h:dataTable value="#{temperatureConvertor.keys}" var="sss">
	...
	<h:outputLabel value="#{sss}"></h:outputLabel>
	
	<h:outputLabel value="#{temperatureConvertor.keyval[sss]}"></h:outputLabel>
	  </h:column>
